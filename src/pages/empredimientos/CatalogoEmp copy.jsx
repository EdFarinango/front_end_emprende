...
export const CatalogoEmp = () => {
  ...
  const whatsapp = (e) => {
    e.preventDefault();
    window.open(
      `https://api.whatsapp.com/send?phone=+593${dato[0].telefono}&text=Hola%20${dato[0].nombre}%20me%20gustaria%20mas%20informacion%20de%20tu%20emprendimiento`
    );
  };
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <i className="fa fa-facebook" /> Contáctanos
                    </a>
                  </button>
                  <button
                    type="button"
