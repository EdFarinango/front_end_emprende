            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    <label
                        ...
                        className='text-gray-700 uppercase font-bold'>Teléfono celular</label>
                    <input
                        id='personal_phone'
                        type="tel"
                        className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md mb-5'
                ...
                <div>
                    <label
                        htmlFor='home_phone'
                        className='text-gray-700 uppercase font-bold'>Número telefónico </label>
                    <input
                        id='home_phone'
                        type="tel"
                        className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md mb-5'
                ...
                <div>
                    <label
                        htmlFor='address'
                        className='text-gray-700 uppercase font-bold'>Dirección domiciliaria</label>
                    <textarea
                        className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md mb-5'
