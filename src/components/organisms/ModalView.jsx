...
const ModalViewEmp = ({ emprendimientos }) => {
    ...
    return (
        <div>
            ...
            <Button className='btnedit' onClick={toggle}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                            ...
                            <div className="w3-container w3-card w3-white w3-round w3-margin"><br />
                                ...
                                <div className="w3-row-padding" style={{ margin: '0 -16px' }}>
                                    <div className="w3-half">
                                        ...
                                        <p>
                                        {data.estado === 1 ? <span className="badge bg-success">Activo</span> : <span className="badge bg-danger">Inactivo</span>}
